...
# installed.
TCL_PREFIX='/workspaces/Techon_GDPR/venv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/workspaces/Techon_GDPR/venv'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /workspaces/Techon_GDPR/venv/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/tk_1769459871528/work=/usr/local/src/conda/tk-8.6.13 -fdebug-prefix-map=/workspaces/Techon_GDPR/venv=/usr/local/src/conda-prefix -pipe -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /workspaces/Techon_GDPR/venv/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/workspaces/Techon_GDPR/venv/lib -Wl,-rpath-link,/workspaces/Techon_GDPR/venv/lib -L/workspaces/Techon_GDPR/venv/lib -Wl,--export-dynamic '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/workspaces/Techon_GDPR/venv/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/workspaces/Techon_GDPR/venv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/workspaces/Techon_GDPR/venv/include'
...
# compiled.
TCL_SRC_DIR='/workspaces/Techon_GDPR/venv/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/workspaces/Techon_GDPR/venv/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/workspaces/Techon_GDPR/venv/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/workspaces/Techon_GDPR/venv/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/workspaces/Techon_GDPR/venv/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/workspaces/Techon_GDPR/venv/lib/libtclstub8.6.a'
